/*
 * $Id: FilterContextImpl.java 221 2006-04-27 21:44:51Z jon $
 * $URL: http://subetha.tigris.org/svn/subetha/trunk/core/src/org/subethamail/core/filter/FilterContextImpl.java $
 */
...
class SendFilterContextImpl extends FilterContextImpl implements SendFilterContext
{
	...
	{
		if (this.cachedThreadRoot == null)
		{
			Mail root = this.mail;
			while (root.getParent() != null)
				root = root.getParent();
	
			this.cachedThreadRoot = Transmute.mailSummary(root, true, null);
		}
		
		return this.cachedThreadRoot;
	}
}
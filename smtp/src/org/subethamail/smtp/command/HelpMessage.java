...
public class HelpMessage {
  ...
  public HelpMessage(String commandName, String argumentDescription, String helpMessage) {
  ...
  public HelpMessage(String commandName, String helpMessage) {
    this(commandName, null, helpMessage);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (argumentDescription != null ? !argumentDescription.equals(that.argumentDescription) : that.argumentDescription != null)
      return false;
    if (commandName != null ? !commandName.equals(that.commandName) : that.commandName != null) return false;
    if (helpMessage != null ? !helpMessage.equals(that.helpMessage) : that.helpMessage != null) return false;
  ...
  public int hashCode() {
    ...
    result = 29 * result + (argumentDescription != null ? argumentDescription.hashCode() : 0);
